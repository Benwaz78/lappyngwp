...
$('.lappy-filter-accordion').on(
    ...
    function (e) {
        ...
        var $parent = $(this).closest('.widget_sub_categories');
        var $submenu = $parent.find('.widget_dropdown_categories');

        // Close others
        $parent
            .siblings('.widget_sub_categories')
            .removeClass('open')
            .find('.widget_dropdown_categories')
            .slideUp(300);
...
/*--- Auto-open active filter on page load ---*/
$('.widget_dropdown_categories li.active').each(function () {

    var $parent = $(this).closest('.widget_sub_categories');

    $parent.addClass('open');
    $parent.find('> a').addClass('active');
    $parent.find('.widget_dropdown_categories').show();
